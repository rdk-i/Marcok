...
Pastikan anda sudah login sebagai root sebelum menjalankan perintah dibawah
 ```html
 wget https://raw.githubusercontent.com/rdk-i/Marcok/main/mar.sh && chmod +x mar.sh && ./mar.sh
 ```
...
![image](https://github.com/rdk-i/Marcokassets/97426017/3aeedf09-308e-41b0-9640-50e4abb77aa0) </br>

Lalu pada tab **Network** pastikan gRPC dan WebSocket sudah ON 
![image](https://github.com/rdk-i/Marcok/assets/97426017/65d9b413-fda4-478a-99a5-b33d8e5fec3d)
...
# Setting Host Marzban
 ...
 ![image](https://github.com/rdk-i/Marcok/assets/97426017/6b96bce7-39c7-4b5c-b01e-8dfdea91cb47) </br>

Lalu ubah variabel {SERVER_IP} dibawah menjadi domain yang sudah di pointing tadi <br>
# CONTOH
![image](https://github.com/rdk-i/Marcok/assets/97426017/191a485c-07a7-4a28-88d3-b66fa403abc7)
</br>